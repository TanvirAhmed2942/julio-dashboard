            ...
            <Table>
                <TableHeader>
                    <TableRow className="border-b border-border bg-muted/40 hover:bg-muted/40">
                        <TableHead className="h-10 w-14 font-semibold text-foreground">
                            SI
                        </TableHead>
                ...
                <TableBody>
                    {rows.map((row, index) => (
                        ...
                        >
                            <TableCell className="w-14 font-medium text-foreground">
